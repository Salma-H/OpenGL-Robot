...
int n = 15;
// poses for arm[1],elbow[1]
int poses[15][2] = {{85, 0}, {80, -10}, {75,-20}, {70, -30}, {60, -45}, {50, -60}, {40,-85}, {35,-95}, {20, -105}, {10, -110}, {0, -115}, {-10,-120},{-25, -120}, {-35,-120}, {-45, -120}};
...
void timer(int v)
{
    ...
    if(dec)
        ...
        f++;
    set_poses(f - 1);
    // std::cout << f <<  "  " << dec << std::endl;
    // std::cout << arm[1] << "  " << elbow[1] << std::endl;
